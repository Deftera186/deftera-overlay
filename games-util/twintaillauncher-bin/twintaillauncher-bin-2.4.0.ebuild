...
src_install() {
	...
	# Resources (reaper, winetricks, game patches, UI locales)
	insinto /usr/lib/${MY_PN}/resources
	doins -r usr/lib/${MY_PN}/resources/*

	# doins flattens modes to 0644; restore the executable bit on the
	# helper programs the launcher spawns (upstream ships them 0755).
	fperms 0755 /usr/lib/${MY_PN}/resources/reaper
	fperms 0755 /usr/lib/${MY_PN}/resources/winetricks
